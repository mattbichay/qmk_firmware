...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [2] = LAYOUT(KC_ESC, KC_LPRN, KC_RPRN, KC_PLUS, KC_MINS, KC_NO, RESET, KC_NO, KC_7, KC_8, KC_9, KC_TRNS,
  ...
  [3] = LAYOUT(KC_NO, KC_F16, KC_F17, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, OSX_PSCR, OSX_LOCK,
               ...
               KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, TD(LANG_KEY_TAP), KC_TRNS, KC_LEFT, KC_DOWN, KC_RIGHT) 
